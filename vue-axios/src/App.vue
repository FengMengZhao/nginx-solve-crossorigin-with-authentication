<template>
    <div id="app">
        ...
        <main>
            ...
            <button id="btn2" class="" v-on:click="logOut">退出登录</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            getJokes: function () {
                this.loading = true;
                //axios.get("http://api.icndb.com/jokes/random/20")
                axios.get("/api/student/20")
                //axios.get("http://192.168.20.31:8081/student/20")
                    .then((response)  =>  {
                        //debugger;
                        this.loading = false;
